...
const Home = () => {
  return (
    <>
      <h1 className=" text-center text-6xl mt-10 ">Home</h1>
      <p className=" text-center text-base p-10">
        ...
        illum qui dolorem eum fugiat quo voluptas nulla pariatur? Section
        ...
        repellat."Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
        ...
        pariatur? Section 1.10.32 of "de Finibus Bonorum et Malorum", written by
